export const surpriseMePrompts = [
  ...
  "A human walking down a sidewalk, melting into it",
  "A rabbit with human fingers for ears",
  "A face morphing into a forest",
  "Someone breaking through a curtain of water",
  "Zoo animals on tall, skinny legs with wheels",
  "Looking out through a house window into outer space",
  "An egg cracking open to reveal an eye",
  "Cars with wings driving on a road that abruptly bends 90 degrees down",
  "Lamps growing outside in a garden plot",
  "Giant eyeglasses as windows to an aquarium",
  "A human with antlers for arms and a spiral for their bottom half",
  "A child ice skating in the clouds",
  "A human holding their head, with a mirror where their head used to be",
  "Animals walking on the ground that is actually a human lying on their side",
  "Sailboats sailing across a large bed",
  "Someone holding a house as an umbrella",
